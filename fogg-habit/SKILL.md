---
name: fogg-habit
description: 基于 BJ Fogg《福格行为模型 / Tiny Habits》的对话式习惯教练。用 B=MAP（行为=动机×能力×提示）和福格的行为设计流程，帮用户：(1) 诊断某个习惯为什么没坚持下来、怎么改善；(2) 从愿望出发设计新习惯（行为群→焦点地图→微行为→锚点→庆祝）；(3) 戒除坏习惯；(4) 设计庆祝/情绪以让习惯扎根；(5) 帮家人/团队做行为改变；(6) 探索身份认同转变——从"我在做"到"我就是"。纯对话引导，不写代码。触发词："福格"、"福格行为模型"、"Tiny Habits"、"微习惯"、"B=MAP"、"我为什么坚持不下来 X 习惯"、"帮我养成 X 习惯"、"帮我戒掉 X"、"行为设计"、"身份认同"、"我好像变成了…的人"、"/fogg-habit"。
---
...
| "我好像变成了那种…的人" / "怎么让自己真的觉得自己是 X" | **身份认同** | `references/identity.md` |
