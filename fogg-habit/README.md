...
覆盖全书核心内容：B=MAP、能力五要素、焦点地图、ABC 三步骤、微行为+锚点、庆祝/Shine、珍珠习惯、顺便习惯、庆祝闪电战、行为升级路径、习惯生长与繁殖、改变的五大技巧、三阶段渐进戒除、动机向量分析、自动化度光谱、福格两原则、群体行为设计七步流程、头目/忍者角色、四分区模型、强力区反馈框架——约 95%+。
