...
- **识别认知障碍** — 发现 6 大认知陷阱，理解为什么你总是"看错"系统
- **与系统共舞** — 学习 15 大生存法则，从"想控制"转变为"会相处"

> 2026-07-08 完成 cangjie-skill RIA++ 全流程重建。新增 2 个 skill（obstacles、dance），全部 6 个 skill 均含快速模式 + test-prompts.json 压力测试。
